...
$HTTPHEADER = "ldpz0jdrsx43jcyswlkn037vstg4ena3";
    ...
    echo '<div class="date floatright" id="psp_last_update">';
    print gmdate("M, j Y H:i:s e", $time['servertime']);
    echo '</div>';
    echo '<h2>Current Performance and Availability Status</h2>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="psp-table" id="table_curr_status"><tbody>
    <tr>
